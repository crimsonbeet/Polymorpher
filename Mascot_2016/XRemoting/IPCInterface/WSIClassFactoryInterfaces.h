...
//	virtual wsi_object& get_current() = 0;
	...
	virtual IWSIObject get_named_current() = 0;
...
public:
	...
	virtual bool NoEmptyRootObjects() { return false; }
...
public:
#if _MSC_VER > 1700
	typedef std::unordered_map<std::string, IWsiSerializerBase*> object_serializers;
#else
