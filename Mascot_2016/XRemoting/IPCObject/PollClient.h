...
public:
	...
	poll_client(XMarshRequestsCtl& ctl, sockclients_map& clmap, fd_set *allset, SOCKET& maxsock, fd_set *rset):
	...
	static BOOL read_vcrfmessage(SOCKET sock, const std::string& header, std::string& msg, int nread);
};
...
public:
	...
	add_client(sockclients_map& clmap, fd_set *allset, SOCKET& maxsock):
