...
short _dart_envelopestructure_namesize = (short)strlen(_dart_envelopestructure_name); 

char *_dart_connectstructure_name = "SDartConnect"; 
short _dart_connectstructure_namesize = (short)strlen(_dart_connectstructure_name); 

char *_dart_packetstructure_name = "SDartPacket"; 
short _dart_packetstructure_namesize = (short)strlen(_dart_packetstructure_name); 

char *_dart_apacketstructure_name = "SDartAPacket"; 
short _dart_apacketstructure_namesize = (short)strlen(_dart_apacketstructure_name); 

char *_dart_datastructure_name = "SDartData"; 
short _dart_datastructure_namesize = (short)strlen(_dart_datastructure_name); 

char *_dartrtls_unknownstructure_name = "SRtlsUnknown"; 
short _dartrtls_unknownstructure_namesize = (short)strlen(_dartrtls_unknownstructure_name); 

char *_dartrtls_presencestructure_name = "SRtlsPresence"; 
short _dartrtls_presencestructure_namesize = (short)strlen(_dartrtls_presencestructure_name); 

char *_dartrtls_2d_calculationstructure_name = "SRtls2DLocation"; 
short _dartrtls_2d_calculationstructure_namesize = (short)strlen(_dartrtls_2d_calculationstructure_name); 

char *_dartrtls_2d_estimatestructure_name = "SRtls2DEstimate"; 
short _dartrtls_2d_estimatestructure_namesize = (short)strlen(_dartrtls_2d_estimatestructure_name); 

char *_dartrtls_3d_calculationstructure_name = "SRtls3DLocation"; 
short _dartrtls_3d_calculationstructure_namesize = (short)strlen(_dartrtls_3d_calculationstructure_name); 

char *_dartrtls_diagnosticstructure_name = "SRtlsDiagnostic"; 
short _dartrtls_diagnosticstructure_namesize = (short)strlen(_dartrtls_diagnosticstructure_name); 

char *_dartrtls_subscribestructure_name = "SRtlsSubscribe"; 
short _dartrtls_subscribestructure_namesize = (short)strlen(_dartrtls_subscribestructure_name); 

char *_dartrtls_unsubscribestructure_name = "SRtlsUnsubscribe"; 
short _dartrtls_unsubscribestructure_namesize = (short)strlen(_dartrtls_unsubscribestructure_name); 
