...
CCRFWriter::CCRFWriter(): CWSIWriter() {
	_name = "CRFWriter";
}

CCRFWriter::CCRFWriter(const CCRFWriter& x): CWSIWriter(x) {
	_name = "CRFWriter";
}

CCRFWriter& CCRFWriter::operator = (const CCRFWriter&) {
	return *this;
}

CCRFWriter::~CCRFWriter() {
}

bool CCRFWriter::NoEmptyRootObjects() {
	return true;
}
