#ifndef XFrameDrawingH
#define XFrameDrawingH
...
class XFrameDrawing: public KFrame { 
public: 
	XFrameDrawing(HINSTANCE hInstance, HWND hParent); 
...
extern XFrameDrawing *_g_drawing_frame; 
extern KDrawing *_g_pDrawing; 


#endif //XFrameDrawingH
